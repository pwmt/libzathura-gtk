...
G_DEFINE_TYPE_WITH_PRIVATE(ZathuraFormFieldText, zathura_gtk_form_field_text, GTK_TYPE_WIDGET)
...
zathura_gtk_form_field_text_new(zathura_form_field_t* form_field)
{
  ...
  gtk_widget_add_controller(GTK_WIDGET(priv->rectangle), key_controller);
...
{
  ZathuraFormFieldTextPrivate* priv = zathura_gtk_form_field_text_get_instance_private(ZATHURA_FORM_FIELD_TEXT(form_field_widget));
