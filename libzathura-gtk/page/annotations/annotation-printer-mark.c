...
static void cb_zathura_gtk_annotation_printer_mark_draw(GtkDrawingArea* area, cairo_t* cairo, int allocated_width, int allocated_height, gpointer data);
...
{
  ZathuraAnnotationPrinterMarkPrivate* priv = zathura_gtk_annotation_printer_mark_get_instance_private(widget);
...
zathura_gtk_annotation_printer_mark_new(zathura_annotation_t* annotation)
{
  ...
  ZathuraAnnotationPrinterMarkPrivate* priv = zathura_gtk_annotation_printer_mark_get_instance_private(ZATHURA_ANNOTATION_PRINTER_MARK(widget));

  priv->annotation = annotation;

  priv->drawing_area = gtk_drawing_area_new();
  gtk_drawing_area_set_draw_func(GTK_DRAWING_AREA(priv->drawing_area), cb_zathura_gtk_annotation_printer_mark_draw, widget, NULL);
...
static void
cb_zathura_gtk_annotation_printer_mark_draw(GtkDrawingArea* area, cairo_t* cairo, int allocated_width, int allocated_height, gpointer data)
{
  GtkWidget* widget = GTK_WIDGET(area);
  (void) allocated_width;
  (void) allocated_height;
  /* ZathuraAnnotationPrinterMarkPrivate* priv = zathura_gtk_annotation_printer_mark_get_instance_private(data); */
