...
static void cb_zathura_gtk_annotation_watermark_draw(GtkDrawingArea* area, cairo_t* cairo, int allocated_width, int allocated_height, gpointer data);
...
zathura_gtk_annotation_watermark_new(zathura_annotation_t* annotation)
{
  ...
  gtk_drawing_area_set_draw_func(GTK_DRAWING_AREA(priv->drawing_area), cb_zathura_gtk_annotation_watermark_draw, widget, NULL);
...
static void
cb_zathura_gtk_annotation_watermark_draw(GtkDrawingArea* area, cairo_t* cairo, int allocated_width, int allocated_height, gpointer data)
{
