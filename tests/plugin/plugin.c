...
#ifdef HAVE_CAIRO
zathura_error_t page_render_cairo(zathura_page_t* page, cairo_t* cairo, int flags);
#endif
...
#ifdef HAVE_CAIRO
zathura_error_t
page_render_cairo(zathura_page_t* page, cairo_t* cairo, int UNUSED(flags))
{
  return ZATHURA_ERROR_OK;
}
